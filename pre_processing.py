...
def plot_prior_inferred_n(n_lambda, inferred_n, section, visualization_dir):
    plt.hist(np.array(n_lambda), bins=50)
    plt.savefig(visualization_dir + '/' + section + '_n_lambda.png', dpi=500)
    plt.close()
    ...
    plt.savefig(visualization_dir + '/' + section + '_lambda_and_inferred.png', dpi=500)
    plt.close()
