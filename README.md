# ClonalGE
This in an extention of Tumoroscope model [1]. It adds one more latent variable (B_kg - average expression of gene g per one cell of clone k), one observed variable (Y_sg - gene expression of gene g in spot s) and several new hyperparameters.
